...
<div class="container">
    ...
    <div class="profile">
        ...
        <div>
            ...
            <p><strong>Name:</strong> <input type="text" value="MURENGEZI FAUSTIN"></p>
            <p><strong>Email:</strong> <input type="text" value="murengezi@gmail.com"></p>
            <p><strong>Phone:</strong> <input type="text" value="+250784933362"></p>
            ...
            <p><strong>Joining Date:</strong> <input type="text" value="May 28, 2024"></p>
